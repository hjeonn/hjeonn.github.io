...
This work develops a CNN-based transfer learning framework to enable battery degradation diagnostics from SEM images when labeled data is scarce and domain shift is present.
